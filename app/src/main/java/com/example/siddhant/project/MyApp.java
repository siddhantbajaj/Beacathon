...
public class MyApp extends Application implements BeaconConsumer{
    ...
    private static final Identifier nameSpaceId = Identifier.parse("5DC33487F02E477D4058");
    ...
    public void setUpBeacon(){
        ...
        ssnRegionMap.put("0117C555C6SF",new Region("18238278",nameSpaceId, Identifier.parse("0x0117c59825E9"),null));
        ssnRegionMap.put("0117C55BE3A8",new Region("4825",nameSpaceId,Identifier.parse("0x0117c55be3a8"),null));
        ssnRegionMap.put("0117C55D6660",new Region("18273624",nameSpaceId,Identifier.parse("0x0117c552c493"),null));
